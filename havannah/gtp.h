...
//		newcallback("ab",              bind(&GTP::gtp_ab,            this, _1), "Switch to use the Alpha/Beta agent to play/solve");
		...
		newcallback("save_sgf",        bind(&GTP::gtp_save_sgf,      this, _1), "Output an sgf of the current tree");
		newcallback("load_sgf",        bind(&GTP::gtp_load_sgf,      this, _1), "Load an sgf generated by save_sgf");
